...
if($wszystko_ok==true)
{
  ...
  $db->query('SET CHARACTER_SET utf8_unicode_ci');
	...
	$zmiana=$db->query("INSERT INTO `admin`(`id`, `Imie`, `Nazwisko`, `Telefon`, `Email`, `login`, `password`)VALUES (NULL, '$_POST[Imie]', '$_POST[Nazwisko]', '$_POST[Telefon]', '$_POST[Email]', '$nick', '$haslo_hash' )");

if($zmiana==1) header("Location: login.php");
 }
...
Czesc! <br/>
Witaj w formularzu rejestracyjnym koordynatora<br/>
Wypelnij prosze swoje dane. Dostep do Twojego numeru telefonu i maila maja pracownicy, ktorzy zapisani sa na wydarzenie, ktore koordynujesz<br/>
Login i Haslo pozostaja tajne. Nie zapomnij ich!</div>
