...
$zapytanie = "select * from pracownik where id='$id'";
$wynik = $db->query($zapytanie);
$ile_znaleziono = $wynik->num_rows;
	$row = $wynik->fetch_assoc();
  echo '<div class="wynikii" style="height: 100px;"><b>';
  echo $row['Imie'].'<br/>';
  echo $row['Nazwisko'].'<br/>';
  echo $row['Email'].'<br/>';
  echo $row['Telefon'].'<br/></b>';
  echo '</div>';
...
$zapytanie = "select event_id,obecny from event_pracownik where pracownik_id='$id'";
$wynik = $db->query($zapytanie);
$ile_znaleziono = $wynik->num_rows;
$godziny=0;
$wydarzen=0;
